<template>
  <Layout :background="'gradient'" :no-sidebar="true">
    <Header :no-sidebar="true" :arr="animationText" :name="'Donald Wellborn'" />
...
-->
      <div class="profile no-photo">
        ...
        <!-- profile titles -->
        <div class="title">Donald Wellborn</div>
        <!--<div class="subtitle">Web Designer</div>-->
        <TypingAnimation :arr="animationText" />
          ...
          <div class="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div class="pricing-item">
              ...
              <div class="feature-list">
                <ul>
                  <li>WorPress Development</li>
                  <li>Installation Services</li>
                  <li>SEO Audit</li>
                  <li class="disable">Hosting &amp; Domain</li>
                  <li class="disable">WordPress Security</li>
                </ul>
              </div>
              <div class="lnks">
                <a href="#" class="lnk">
            ...
            <div class="pricing-item">
              ...
              <div class="feature-list">
                <ul>
                  ...
                  <li>Installation Services</li>
                  <li>SEO Audit</li>
                  <li>Hosting &amp; Domain <strong>new</strong></li>
                  <li>WordPress Security <strong>new</strong></li>
                </ul>
              </div>
              <div class="lnks">
                <a href="#" class="lnk">
          ...
          <div class="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div class="skills-list list">
              ...
              <ul>
                ...
                <li>
                  <div class="name">SEO Optimize</div>
                </li>
                <li>
                  <div class="name">Responsive and mobile-ready</div>
                </li>
                <li>
                  <div class="name">Advertising services</div>
                </li>
                <li>
                  <div class="name">HTML, CSS, jQuery</div>
                </li>
                <li>
